...
try {
    ...
    $sql = "insert into tuote (tuotenimi,kuvaus,kuvannimi,hinta,tuoteryhmanro) values ('$name','varakuva.jpg',$price,$category_id)";
    executeInsert($db,$sql);
    //$data = array('id' => $db->lastInsertId(),'name' => $name,'price' => $price, 'image' => 'placeholder.png'); //puuttuu kuvaus.
